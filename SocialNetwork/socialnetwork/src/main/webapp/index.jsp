...
<body>
		...
		<form class="w-50" method="post" action="login">
		  <div class="d-flex justify-content-center w-100">
	  		<div class="form-group w-50">
			    ...
			    <c:if test="${status == -2 }">
			    	<small id="emailHelp" class="form-text text-muted text-danger"><div class="text-danger">Tên đăng nhập không chính xác. </div></small>
			    </c:if>
		  ...
		  <div class="d-flex justify-content-center w-100">
		  		<div class="form-group w-50">
				    ...
				    <c:if test="${status == -1 }">
			    	<small id="passwordlHelp" class="form-text text-muted "><div class="text-danger">Mật khẩu không chính xác. </div></small>
			    </c:if>
			  	</div>
		  </div>
	...
	<div class="d-flex justify-content-center align-items-center mt-3">
		<div class="w-25 d-flex justify-content-center">		
			<a href="register" class="btn btn-success text-white w-100">Đăng ký</a>
		</div>
	</div>
	<div class="d-flex justify-content-center align-items-center mt-3">
		<div class="w-25 d-flex justify-content-center">		
	...
	<div class="d-flex justify-content-center align-items-center mt-3">
		<div class="w-25 d-flex justify-content-center">		
			<a href="cms/login" >Đăng nhập trang quản lý</a>
		</div>
	</div>
</body>
</html>